...
## Add codes which can save video as picture locally
#
#def detectFaceOpenCVHaar(faceCascade, frame, inHeight=300, inWidth=0):
#    # 修改帧大小为高度300，宽度据情况而变（frameWidth/frameHeight）* inHeight
#    # 这里只是对帧大小进行调整，但还未真正落实
...
# Second Backups on 15th May
# Change directory in order to make structures more clearly, only change code in main
